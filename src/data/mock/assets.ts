...
export const assetSeed: Asset[] = [
  ...
  // --- Участок дробления / Линия №1 ---
  {
    ...
    status: 'in_operation', criticality: 'critical',
    manufacturer: 'Уралмаш', modelName: 'ЩДП-12х15', serialNumber: 'SN-CR-0012',
    inventoryNumber: 'INV-100012', commissionedAt: '2018-06-12', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  {
    ...
    status: 'in_operation', criticality: 'high',
    manufacturer: 'ЭЛДИН', modelName: 'АИР-355', serialNumber: 'SN-MT-3551',
    inventoryNumber: 'INV-100013', commissionedAt: '2018-06-12', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  {
    ...
    functionalLocationId: 'fl-dof-crush-l1', parentAssetId: null,
    status: 'maintenance', criticality: 'high',
    manufacturer: 'Конвейер-Маш', modelName: 'КЛ-800', serialNumber: 'SN-CV-0801',
    inventoryNumber: 'INV-100020', commissionedAt: '2019-03-01', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  {
    ...
    status: 'in_operation', criticality: 'medium',
    manufacturer: 'Вибротехник', modelName: 'ГИТ-51', serialNumber: 'SN-SC-0510',
    inventoryNumber: 'INV-100025', commissionedAt: '2020-09-15', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  // --- Участок дробления / Линия №2 ---
  {
    ...
    inventoryNumber: 'INV-100070', commissionedAt: '2019-07-01', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  {
    ...
    inventoryNumber: 'INV-100071', commissionedAt: '2019-07-01', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  {
    ...
    inventoryNumber: 'INV-100072', commissionedAt: '2019-07-01', owner: 'ДОЦ', planner: 'Иванов А. С.',
  },
  ...
  // --- Участок флотации ---
  {
    ...
    inventoryNumber: 'INV-100030', commissionedAt: '2017-11-20', owner: 'ДОЦ', planner: 'Петрова Е. В.',
  },
  {
    ...
    inventoryNumber: 'INV-100031', commissionedAt: '2017-11-20', owner: 'ДОЦ', planner: 'Петрова Е. В.',
  },
  {
    ...
    inventoryNumber: 'INV-100035', commissionedAt: '2021-05-10', owner: 'ДОЦ', planner: 'Петрова Е. В.',
  },
  {
    id: 'as-flot-2', code: 'ФЛТ-002', name: 'Флотомашина РИФ-8.5 (секция 2)',
    classification: 'Флотомашина / Пневмомеханическая', classificationId: 'cl-flotation',
    functionalLocationId: 'fl-dof-flot', parentAssetId: null,
    status: 'standby', criticality: 'medium',
    manufacturer: 'Механобр', modelName: 'РИФ-8.5', serialNumber: 'SN-FL-0086',
    inventoryNumber: 'INV-100036', commissionedAt: '2021-05-10', owner: 'ДОЦ', planner: 'Петрова Е. В.',
  },
  {
    ...
    functionalLocationId: 'fl-dof-flot', parentAssetId: null,
    status: 'fault', criticality: 'high',
    manufacturer: 'ГМС Ливгидромаш', modelName: 'ГрАТ-225', serialNumber: 'SN-PP-2250',
    inventoryNumber: 'INV-100040', commissionedAt: '2019-08-22', owner: 'ДОЦ', planner: 'Петрова Е. В.',
  },
  ...
  // ====== Плавильно-печной цех ======
  {
    ...
    inventoryNumber: 'INV-200010', commissionedAt: '2016-02-01', owner: 'ППЦ', planner: 'Кузнецов И. Д.',
  },
  {
    ...
    inventoryNumber: 'INV-200011', commissionedAt: '2016-02-01', owner: 'ППЦ', planner: 'Кузнецов И. Д.',
  },
  {
    ...
    inventoryNumber: 'INV-200015', commissionedAt: '2015-05-20', owner: 'ППЦ', planner: 'Кузнецов И. Д.',
  },
  {
    ...
    inventoryNumber: 'INV-200020', commissionedAt: '2017-09-10', owner: 'ППЦ', planner: 'Кузнецов И. Д.',
  },
  {
    ...
    inventoryNumber: 'INV-200021', commissionedAt: '2017-09-10', owner: 'ППЦ', planner: 'Кузнецов И. Д.',
  },
  ...
  // ====== Прокатный цех ======
  {
    ...
    inventoryNumber: 'INV-300010', commissionedAt: '2018-11-05', owner: 'ПРЦ', planner: 'Федотова Л. А.',
  },
  {
    ...
    inventoryNumber: 'INV-300011', commissionedAt: '2018-11-05', owner: 'ПРЦ', planner: 'Федотова Л. А.',
  },
  {
    ...
    inventoryNumber: 'INV-300020', commissionedAt: '2018-11-05', owner: 'ПРЦ', planner: 'Федотова Л. А.',
  },
  {
    ...
    inventoryNumber: 'INV-300030', commissionedAt: '2019-02-15', owner: 'ПРЦ', planner: 'Федотова Л. А.',
  },
  ...
  // --- Насосная станция ---
  {
    ...
    inventoryNumber: 'INV-100050', commissionedAt: '2016-04-18', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    inventoryNumber: 'INV-100051', commissionedAt: '2016-04-18', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    inventoryNumber: 'INV-100053', commissionedAt: '2016-04-18', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    inventoryNumber: 'INV-100052', commissionedAt: '2016-04-18', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  // --- Компрессорная станция ---
  {
    ...
    inventoryNumber: 'INV-100060', commissionedAt: '2020-02-14', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    inventoryNumber: 'INV-100061', commissionedAt: '2015-10-05', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    status: 'in_operation', criticality: 'low',
    manufacturer: 'Бугульма-Энерго', modelName: 'ТКГ-200', serialNumber: 'SN-HX-0200',
    inventoryNumber: 'INV-100062', commissionedAt: '2015-10-05', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
  {
    ...
    inventoryNumber: 'INV-100065', commissionedAt: '2021-12-01', owner: 'ЭНЦ', planner: 'Сидоров К. П.',
  },
];
